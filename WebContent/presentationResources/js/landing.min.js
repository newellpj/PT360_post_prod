(function(angular){angular.module('landingApp',['aboutUsTabPage','appTabPage']).component('employmeeProfile',{template:``,controller:function($scope,$http,$log){}}).component('welcomePage',{template:`
              ...
              <div class="carouselAndBuzzSection responsive">
							...
							Senior Financial Officer </p>	<p><b>Position:</b>Finance & Billing </p><p><b>Location:</b> 64 Flinders Street, Melbourne</p></li>
									...
									`,controller:function($scope,$http,$log){}})})(angular);function openTabAboutUs(evt,tabName){$('._stickFigureElement').toggleClass('stickFigureElement-active');openTab(evt,tabName)}
function openTab(evt,tabName){console.log("we in open tab?");var i,tabcontent,tablinks;tabcontent=document.getElementsByClassName("tabcontent");for(i=0;i<tabcontent.length;i++){tabcontent[i].style.display="none"}
tablinks=document.getElementsByClassName("tablinks");for(i=0;i<tablinks.length;i++){tablinks[i].className=tablinks[i].className.replace(" active","")}
console.log("2 we in open tab?");document.getElementById(tabName).style.display="block";evt.currentTarget.className+=" active";if(tabName='welcomeTab'){var bxViewportHeight=$(".bx-viewport").height();console.log("viewport height : "+bxViewportHeight);if(bxViewportHeight<300){console.log("in herefdsfs");$(".carouselAndBuzzSection").css("margin-bottom","25%")}else{$(".carouselAndBuzzSection").css("margin-bottom","0%")}}
console.log("3 we in open tab?")}
function paginateFinish(){console.log('we here$%^%$$^%&%^&^%&*^%&^%&')}