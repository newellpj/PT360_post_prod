(function(angular){angular.module('aboutUsTabPage',[]).component('aboutUsPage',{template:`<div class="aboutUsSpiel responsive"><p>Personnel Tracker is an evolving
    ...
    </div>`,controller:function($scope,$http,$log){var $contactFormCtrl=this;$scope.submitEnquiry=function(){document.getElementById("waiter2").style.display="block";$("#submitEnquiry").prop("disabled",!0);$http({url:'sendEnquiry',method:'GET',headers:{'Content-Type':'application/json'},dataType:"JSON",params:{name:$scope.contactDetName,email:$scope.contactDetEmail,number:$scope.contactDetPhone,message:$scope.contactDetMessage}}).then(function successCallback(successErrorCode){$log.info('successErrorCode : '+successErrorCode[0]);$(".ajax-loader-2a").css("display","none");$(".successErrorMsg").html("Enquiry successfully sent!");$(".successErrorMsg").fadeIn("slow");$(".successErrorMsg").fadeIn("3000");$(".successErrorMsg").fadeOut("slow");$(".successErrorMsg").fadeOut("3000");$("#submitEnquiry").prop("disabled",!1)},function errorCallback(response){$log.error("we errored here : "+data[0]);$(".ajax-loader-2a").css("display","none");$(".successErrorMsg").fadeIn("slow");$(".successErrorMsg").fadeIn("2000");$(".successErrorMsg").html("<span style='color:red;'>Enquiry not sent</span>");$(".successErrorMsg").html("Enquiry successfully sent!");$(".successErrorMsg").fadeOut("slow");$(".successErrorMsg").fadeOut("3000");$("#submitEnquiry").prop("disabled",!1);$(confirmDialog).dialog("open");$(confirmDialog).html("<div style='align:center'><p>Your enquiry could not be sent. Please check your email address and send again.</p></div>")});return!1}}})})(angular)